...
const seedTasks: TaskRecord[] = [
  {
    ...
    project: "Banani Commercial Tower",
    client: "Nabil Group",
  ...
  },
  {
    ...
    project: "Dhanmondi Residential Building",
    client: "Rafiq Ahmed",
  ...
  },
  {
    ...
    project: "Uttara Food Court Block",
  ...
  },
  {
    ...
    project: "Gulshan Showroom Block",
    client: "Bengal Workspace Ltd",
    assignedTo: "Mehedi Islam",
...
const autoGeneratedTasks: TaskRecord[] = Array.from({ length: 70 }).map(
  (_, index) => {
    ...
    const projectPool = [
      ...
      "Dhanmondi Residential Building",
      "Gulshan Showroom Block",
      "Uttara Food Court Block",
      "Bashundhara Corporate Block",
      "Mirpur Studio Complex",
      "Chattogram Retail Plaza",
    ];
    ...
    return {
      ...
      title: `Follow-up task ${seq} for construction workflow`,
      ...
      notes: "Sample task generated for reporting and dashboard purposes.",
    };
  },
);
